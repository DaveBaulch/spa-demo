                ...
                <nav aria-label="Contact items">
                  ...
                  <ul class="footer-nav">
                    ...
                    <li class="footer-nav__item">
                      <img src="@/assets/images/svg/icon-phone.svg" class="footer-nav__item-icon" alt="" aria-hidden="true"/>
                      <a :href="'tel:' + blockData.col1Phone" class="footer-nav__link">{{ blockData.col1Phone }}</a>
                    </li>

                    <li class="footer-nav__item">
                      <img src="@/assets/images/svg/icon-mail.svg" class="footer-nav__item-icon" alt=""aria-hidden="true"/>
